                                ...
                                <div class="collapse" id="collapseCardExample1">
                                    <div class="card-body">
                                        <form action="http://localhost:8000/admintemplate/CRUD/Users.php" method="post" class="form">
                                            ...
                                            <div class="form">
                                                <label>Enter your LastName: <input type="text" name="User_LastName" required /></label>
                                            </div>
                                            <div class="form">
                                                <label>Enter your Email: <input type="email" name="User_Email" required /></label>
                                            </div>
                                            <div class="form">
                                                <label>Enter your Password: <input type="password" name="User_Password" required /></label>
                                            </div>
                                            <div class="form">
                                                <label>Enter your Phone: <input type="tel" name="User_Phone" pattern="[0-9]{10}" required /></label>
                                            </div>
                                            <div class="form">
                                ...
                                <div class="collapse" id="collapseCardExample2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        if (isset($_GET['id'])) {
                                            ...
                                            $url = "http://admin_API:8080/api/users/" . $id;
