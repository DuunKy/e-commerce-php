<head>
    ...
    <title>Dunky Admin - Products</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../adminindex.html">
            ...
            <div class="sidebar-brand-text mx-3">Dunky<sup>&Co</sup></div>
        </a>
            ...
            <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <!--                   <a class="collapse-item" href="ShoppingLists.html">ShoppingLists</a>
                                       ...
                                       <a class="collapse-item" href="Ratings.html">Ratings</a>-->
                </div>
            </div>
        </li>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">PRODUCTS CRUD requests</h1>
                    <a href="../allProducts.php" class="btn btn-info btn-icon-split">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="collapse" id="collapseCardExample1">
                                <div class="card-body">
                                    <form action="http://localhost:8000/admintemplate/CRUD/Products.php" method="post" class="form">
                                        <div class="form">
                                            <label>Enter your Product's name: <input type="text" name="Product_Name" required /></label>
                                        </div>
                                        <div class="form">
                                            <label>Enter your Description: <input type="text" name="Product_Description" required /></label>
                                        </div>
                                        <div class="form">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="collapse" id="collapseCardExample2">
                                <div class="card-body">
                                    <form action="http://localhost:8000/admintemplate/CRUD/Products.php" method="get" class="form">
                                        <div class="form">
                                            <label>Enter product ID: <input type="text" name="id" required /></label>
                                        </div>
                                        <div class="form">
                                            <input type="submit" value="Send" />
                                        </div>
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        if (isset($_GET['id'])) {
                                            // Retrieve the value of the 'id' parameter
                                            $id = $_GET['id'];
                                            // Construct the complete URL with the retrieved ID
                                            $url = "http://admin_API:8080/api/products/" . $id;
                                            ...
                                            echo "<tr>" .
                                                ...
                                                "<td>$response->Product_NumberLeft</td>" .
                                                "</tr>";
                                        }
                                        ?>
                                        </tbody>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="collapse" id="collapseCardExample3">
                                <div class="card-body">
                                    <form action="http://localhost:8000/admintemplate/CRUD/Products.php" method="put" class="form">
                                        <div class="form">
                                            <label>Enter your Product's name: <input type="text" name="Product_Name" required /></label>
                                        </div>
                                        <div class="form">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="collapse" id="collapseCardExample4">
                                <div class="card-body">
                                    <form action="http://localhost:8000/admintemplate/CRUD/Products.php" method="delete" class="form">
                                        <div class="form">
                                            <label>Enter your Product's name: <input type="text" name="Product_Name" required /></label>
                                        </div>
                                        <div class="form">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Dunky&Co 2024</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
